...
public class LevelOneLearningAnimalsActivity extends AppCompatActivity {

    private ViewPager slideview;
    private LinearLayout slideNav;
    private LevelOneAnimalsCardAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_levelonelearninganimals);
        initComponents();

        adapter = new LevelOneAnimalsCardAdapter(this);
    ...
    private void dotsViewIndicator(int position) {
        ...
        if (mDots.length > 0) {
            MediaPlayer.create(LevelOneLearningAnimalsActivity.this,voice_clips[position]).start();
