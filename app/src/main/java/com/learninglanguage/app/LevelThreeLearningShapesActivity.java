...
import com.learninglanguage.app.Adapters.LevelThreeShapesCardAdapter;

public class LevelThreeLearningShapesActivity extends AppCompatActivity {

    private ViewPager slideview;
    private LinearLayout slideNav;
    private LevelThreeShapesCardAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_three_learning_shapes);
        initComponents();

        adapter = new LevelThreeShapesCardAdapter(this);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (next.getText().toString().equals("Finish")){
                    startActivity(new Intent(LevelThreeLearningShapesActivity.this,LevelThreeTestingAnimalsActivity.class));
                }else{
                    slideview.setCurrentItem(currentPage + 1);
                }
            }
    ...
    private void dotsViewIndicator(int position) {
        ...
        if (mDots.length > 0) {
            MediaPlayer.create(LevelThreeLearningShapesActivity.this,voice_clips[position]).start();
